...
Ci sono diversi modi, io sto usando l'estensione "OpenBPMN" che trovate su VS Code, che funziona anche offline a differenza del Signavio visto a lezione. Inoltre VS Code ha git integrato quindi è facile da usare in gruppo con gli amici. VS Code è gratis e se avete fatto informatica dovreste già averlo, altrimenti potete scaricarlo in pochi minuti su qualunque sistema operativo. Vi lascio un paio di link utili:
